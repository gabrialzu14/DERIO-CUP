...
export const metadata:Metadata={title:"Derio Cup",description:"Benjamin 2017 • 20 de Septiembre",applicationName:"Derio Cup",icons:{icon:"/tournament-logo.jpg",shortcut:"/tournament-logo.jpg",apple:"/tournament-logo.jpg"}};
